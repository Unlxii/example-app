            ...
            <div class="bg-white dark:bg-gray-800 overflow-hiddenshadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <a href="{{ route('diary.create') }}"
                        class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase
                    tracking-widest hover:bg-blue-500 active:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150 mb-4">
                        {{ __('Add New Entry') }}
                    </a>
                    ...
                    <div class="mb-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg shadow-md">
                        ...
                        <div class="mt-4">
                            ...
                            <ul class="list-disc pl-5">
                                ...
                                <li class="text-gray-700 dark:text-gray-300">{{ $emotion->name }} (Intensity:
                                    {{ $emotion->pivot->intensity }})
                                </li>
                                @endforeach
                            </ul>
                        </div>
